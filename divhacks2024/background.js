...
chrome.tabs.onUpdated.addListener((tabId, changeInfo, tab) => {
  if (changeInfo.status === 'complete' && tab.url === 'facebook.com', 'twitter.com', 'tiktok.com', 'instagram.com', 'reddit.com', 'snapchat.com', 'youtube.com', 'linkedin.com', 'discord.com', 'pinterest.com') {
    chrome.action.openPopup(); // This opens the popup defined in `default_popup`
  }
});
